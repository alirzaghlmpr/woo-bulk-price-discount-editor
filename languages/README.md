...
- `bulk-price-discount-editor.pot` - Translation template (POT file)
- `bulk-price-discount-editor-fa_IR.po` - Persian translation source
- `bulk-price-discount-editor-en_US.po` - English translation source
...
2. Open the `.po` file you want to compile (e.g., `bulk-price-discount-editor-fa_IR.po`)
...
2. Set **Site Language** to:
   - `فارسی` (Persian) - Will load `bulk-price-discount-editor-fa_IR.mo`
   - `English (United States)` - Will load `bulk-price-discount-editor-en_US.mo`

## Adding a New Language

1. Copy the `.pot` file
2. Rename it to `bulk-price-discount-editor-{locale}.po` (e.g., `bulk-price-discount-editor-fr_FR.po` for French)
...
2. **Check the filename** - Must match pattern: `bulk-price-discount-editor-{locale}.mo`
...
add_action('admin_footer', function() {
    global $l10n;
    if (isset($l10n['bulk-price-discount-editor'])) {
