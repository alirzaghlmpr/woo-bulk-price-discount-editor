    ...
    public function enqueue_assets($hook)
    {
        ...
        wp_localize_script('bulk-pricer-admin-js', 'sbp_vars', array(
            ...
            'i18n' => array(
                ...
                'processing_batch' => __('⏳ Applying batch', 'bulk-price-discount-editor-for-woocommerce'),
                'confirm_apply' => __('Are you sure you want to apply changes to all products?', 'bulk-price-discount-editor-for-woocommerce'),
                'success' => __('✅ Changes successfully applied to all products. Please refresh the page.', 'bulk-price-discount-editor-for-woocommerce'),
